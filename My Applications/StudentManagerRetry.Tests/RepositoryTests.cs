...
namespace StudentManagerRetry.Tests
{
    [TestFixture]
    public class RepositoryTests
    {

        private const string _filePath = @"C:\Data\StudentManagerRetry\StudentTest.txt";
        private const string _originalData = @"C:\Data\StudentManagerRetry\StudentTestSeed.txt";
